    ...
    <div class="container">
      <div class="row row-content">
        <div class="col-12 col-md-6 col-lg-6">
          <div class="hero-headline">Register
            <br>
        </div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="pincode" type="text" class="form-control{{ $errors->has('pincode') ? ' is-invalid' : '' }} border" name="pincode" value="{{ old('pincode') }}" required>
                                ...
                                @endif
                                <span id="pincodereturn" class="invalid-feedback" role="alert">Enter correct pincode</span>
                            </div>
                        </div>
