...
<body>
    <div id="app">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="/book_tests">Tests</a>
                                <a class="dropdown-item" href="/book_offers">Offers</a>
                        ...
                        @else
                            <li class="nav-item">
                                <a class="nav-link" href="{{url('/viewcart/'.Auth::user()->id)}}">View Cart</a>
                            </li>
                            <li class="nav-item dropdown">
                                <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
        ...
        <!-- Footer -->
        <footer style="background-color:white; color: black;" class="page-footer font-small pt-4">
